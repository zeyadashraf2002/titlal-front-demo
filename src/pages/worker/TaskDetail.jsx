// frontend/src/pages/worker/TaskDetail.jsx - FINAL VERSION (No Plants, Reference Images from Section)
...
const TaskDetail = () => {
  ...
  useEffect(() => {
    if (task) {
      // ✅ Load reference images from task (Backend gets them from Section)
